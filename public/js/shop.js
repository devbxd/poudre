...
async function loadHomeProducts() {
  ...
  const sections = [
    ...
    { title: 'Watches', cat: 'Watches', tabs: null, viewAll: 'Watches' },
    { title: 'Sunglasses', cat: 'Sunglasses', tabs: null, viewAll: 'Sunglasses' },
    { title: 'Makeup', cat: 'Makeup', tabs: null, viewAll: 'Makeup' },
    { title: 'Perfumes', cat: 'Perfumes', tabs: null, viewAll: 'Perfumes' },
    { title: 'Bath & Body', cat: 'Bath & Body', tabs: null, viewAll: 'Bath & Body' },
    { title: 'Skincare', cat: 'Skin Care', tabs: null, viewAll: 'Skin Care' },
    { title: 'Suncare & Tanning', cat: 'Sun Care/Tanning', tabs: null, viewAll: 'Sun Care/Tanning' },
